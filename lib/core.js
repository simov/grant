...
module.exports = exports = function (opts) {
  ...
  this.generateNext = function () {
    ...
    return function () {
      ...
      (token_based) && (info.results = args[3]);
...
exports.requirePlugin = function (opts) {
  return require('../plugins/' + opts.type.toLowerCase() + (opts.flow ? '_' + opts.flow : '') + (opts.version && typeof opts.version === 'number' ? '_' + opts.version : '') + (opts.leg && typeof opts.leg === 'number' ? '_' + opts.leg + '-legged' : '') + '.js');
};