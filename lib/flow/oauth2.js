...
exports.authorize = async (provider) => {
...
exports.access = async (provider, authorize, session) => {
  if (!authorize.code) {
    ...
    throw {error: 'Grant: OAuth2 state mismatch'}
  }
  var options = {
    method: 'POST',
  ...
  try {
    ...
    return response(provider, body, session)
  }
  catch (err) {
